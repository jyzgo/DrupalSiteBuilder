 ...
 */
 $settings['file_private_path'] = 'site/default/files/private_files';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_DrupalGoOver_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_DrupalGoOver_dd.inc';
}
// </DDSETTINGS>
